...
@bot.on(ice_cmd(outgoing=True, pattern=r"compress(?: |$)(.*)"))
async def _(event):
...
@bot.on(ice_cmd(outgoing=True, pattern=r"addzip(?: |$)(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"upzip(?: |$)(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"rmzip(?: |$)(.*)"))
