...
from userbot.utils import bash, chrome, edit_or_reply, ice_cmd, progress
...
@ice_cmd(pattern="deez (.+?|) (FLAC|MP3\_320|MP3\_256|MP3\_128)")
async def _(event):
