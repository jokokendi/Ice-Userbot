...
@bot.on(ice_cmd(outgoing=True, pattern=r"notes$"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"clear (\w*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"save (\w*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"rmbotnotes (.*)"))
