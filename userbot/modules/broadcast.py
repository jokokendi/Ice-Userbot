...
@bot.on(ice_cmd(outgoing=True, pattern=r"sendto ?(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"fwdto ?(.*)"))
async def catbroadcast_send(event):
    if event.fwd_from:
        return
    catinput_str = event.pattern_match.group(1)
...
@bot.on(ice_cmd(outgoing=True, pattern=r"addto ?(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"rmfrom ?(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"bclist ?(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"bclistall ?(.*)"))
async def catbroadcast_list(event):
    if event.fwd_from:
        return
...
@bot.on(ice_cmd(outgoing=True, pattern=r"frmfrom ?(.*)"))
async def catbroadcast_remove(event):
    if event.fwd_from:
        return
    catinput_str = event.pattern_match.group(1)
...
@bot.on(ice_cmd(outgoing=True, pattern=r"delc ?(.*)"))
