...
@bot.on(ice_cmd(outgoing=True, pattern=r"anilist ?(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"anime ?(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"manga ?(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern="a(kaizoku|kayo) ?(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"char ?(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern="upcoming$"))
...
@bot.on(ice_cmd(outgoing=True, pattern="whatanime$"))
