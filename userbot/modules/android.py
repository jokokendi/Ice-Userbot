...
@bot.on(ice_cmd(outgoing=True, pattern="magisk$"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern="pixeldl(?: |$)(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
