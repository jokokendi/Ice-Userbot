...
@bot.on(ice_cmd(outgoing=True, pattern=r"addbl(?: |$)(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"listbl(?: |$)(.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"rmbl(?: |$)(.*)"))
