...
@bot.on(ice_cmd(outgoing=True, pattern=r"filter (.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"stop (.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"delfilterbot (.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"filters$"))
