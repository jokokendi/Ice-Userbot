...
@bot.on(ice_cmd(outgoing=True, pattern=r"reserved$"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"name"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"setpfp$"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"setbio (.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"username (.*)"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"count$"))
...
@bot.on(ice_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(ice_cmd(pattern=r"info(?: |$)(.*)", outgoing=True))
async def who(event):
